...
const response = useSelector((state) => state.PostJobresponse)
const {loading: loadingSave,success: successSave,error: errorSave,} = response;
...
console.log(newErrors)
   ...
   if ( Object.keys(newErrors).length > 0 ) {
    ...
    dispatch(PostJob({"title":form.title,"description":form.description,"location":form.location,"type":form.type,"skill_required":form.skill_required,"seniority_level":form.seniority_level}));
...
//description error
  ...
  else if ( description.length > 20000 ) newErrors.description = 'write a description'
  //title error
...
const PostJobresponse = useSelector((state) => state.PostJobresponse)
const {success}= PostJobresponse ;
