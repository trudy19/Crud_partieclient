...
import {RegisterRecruiterAction} from "../Redux/Actions/RecruiterActions";
import {useDispatch,useSelector} from "react-redux";


function RegisterRecruiter(props) {
...
const dispatch=useDispatch();
    const submitHandler = (e) => {
        ...
        dispatch(RegisterRecruiterAction(name,email,location,password));
